...
try {
  ...
  git add directory/apps/math-grader directory/apps/teacher-desk directory/apps/scan-equip directory/apps/daily-14 `
    directory/index.html directory/202608/index.html directory/202608/20260826-learning-log.html `
    scripts/install-desktop-apps.ps1 `
    ...
    scripts/scan-equip-app.ps1 scripts/install-scan-equip.ps1 scripts/README-scan-equip.md `
    scripts/pull-export-from-dash-repo.ps1 2>$null
  $pending = git status --porcelain
  if ($pending) {
    git commit -m "學習日誌：新增每日14樣功課手機勾選入口"
    git push origin HEAD
    Write-Host "Pushed. Phone URLs:"
    Write-Host "https://copyshae.github.io/hello-world/directory/"
...
Write-Host "Learning log: https://copyshae.github.io/hello-world/directory/"
Write-Host "Daily 14: https://copyshae.github.io/hello-world/directory/apps/daily-14/"
