...
| 捷徑 | 用途 |
|------|------|
| **習作台.vbs** | 掌握程度／發送狀態／篩選／管道／LINE 文案／匯入匯出／掃描夾 |
...
請雙擊 **習作台.vbs**（不要只貼說明文字到 PowerShell；舊的 `習作台.cmd` 可留著查錯）。
...
- **習作批改**：電腦／手機批閱、產練習檔（國中課本形式：【題號】【摘要】【診斷】【程度】【建議】【自學練習】）  
- **習作台**（電腦或手機）：誰該發、貼群發文（一～四步驟）、追蹤回傳、與手機互通班級資料；可從習作批改同步程度
