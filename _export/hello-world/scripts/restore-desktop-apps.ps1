...
.NOTES
  護眼提醒（0801）不在此腳本；分支 cursor/eye-care-reminders-433c。
#>
param(
  [switch]$ShowTip,
  [switch]$FirstInstall
...
$refreshUrl = "https://raw.githubusercontent.com/copyshae/-/$branch/_export/hello-world/scripts/refresh-desktop-vbs.ps1"
